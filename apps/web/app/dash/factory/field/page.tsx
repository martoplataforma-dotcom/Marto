...
export default function FactoryFieldPage() {
  const mock = useMemo(() => {
    return {
      blocks: [
        {
          title: 'SLA de instalação',
          desc: 'Tempo real por praça, prestador e tipo de produto.',
          tag: 'Tempo real',
        },
        {
          title: 'Checklist & evidências',
          desc: 'Antes/depois, fotos, validação e “o que falhou”.',
          tag: 'Prova',
        },
        {
          title: 'Falhas de campo',
          desc: 'Agrupar por peça faltante, encaixe, dano e instrução.',
          tag: 'Causa',
        },
      ],
      next: [
        'Endpoint: /factories/me/field/summary (SLA, atrasos, causas)',
        'Tela: “atrasos críticos” com drill-down por pedido',
        'Integração futura: prestador anexar evidência (foto/vídeo)',
      ],
    };
  }, []);
      ...
      <div className="mx-auto max-w-6xl p-6">
        <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 text-sm text-white/65">
              O que acontece depois da compra: evidência, SLA e falhas reais.
            </p>
        ...
        <section className="rounded-2xl border border-white/10 bg-neutral-950/60 p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.04)] backdrop-blur">
          ...
          <p className="mt-1 text-sm text-white/65">
            Aqui entra o pós-venda real: instalação vira dado confiável e
            melhoria contínua.
          </p>
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <div className="mt-3 text-xs text-white/55">
                Depois: cada sinal abre o pedido e já mostra evidência (foto,
                checklists, tempo).
              </div>
            </div>
          </div>
